...
//creating a route- Function to calculate admin stats
router.get("/", async (req, res) => {
    try {
        // counts total number of orders
        const totalOrders = await Order.countDocuments();

        // calculates total sales (sum of all totalPrice from orders)
        ...
        // checking if there are any tTrending books statistics: 
